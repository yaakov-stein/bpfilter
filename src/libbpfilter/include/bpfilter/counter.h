 ...
 *  Number of times the counter has been hit (packets for packet hooks,
 *  syscalls for sock_addr hooks).
 * @var bf_counter::size
 *  Accumulated size in bytes. Always 0 for non-packet hooks (e.g.
 *  cgroup_sock_addr).
 */
struct bf_counter
{
